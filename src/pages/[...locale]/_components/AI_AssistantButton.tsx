	...
	return (
		...
		>
			...
			<div class="flex flex-col items-start font-mono">
				<span class="text-[10px] font-bold tracking-[0.2em] text-primary group-hover:text-glow">AI_ASSISTANT</span>
				<span class="text-[9px] text-muted-foreground/60 uppercase tracking-widest">Awaiting Prompt...</span>
			</div>
		</button>
	);
}
