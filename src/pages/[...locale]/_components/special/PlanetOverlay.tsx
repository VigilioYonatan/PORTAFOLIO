...
export default function PlanetOverlay() {
    ...
    return (
        ...
        >
            ...
            >
                <span class="text-[10px] font-black tracking-widest opacity-0 group-hover:opacity-100 transition-opacity">EXIT_REAPER</span>
                <XIcon size={32} />
            </button>
        </div>
    );
        ...
        >
            ...
            {isVideoLoading.value && !hasError.value && (
             ...
             {hasError.value && (
                <div class="absolute inset-0 z-20 flex flex-col items-center justify-center bg-zinc-950 p-4 text-center">
                    <span class="text-purple-500/50 font-black tracking-widest text-xs mb-2">LINK_FAILURE</span>
                    <span class="text-white/20 font-mono text-[10px] uppercase">UNDEFINED_REAPER_SOURCE</span>
                </div>
            )}
            ...
            <video
                ...
                class={cn(
                    ...
                    isVideoLoading.value ? "opacity-0" : "opacity-40 group-hover:opacity-100"
                )}
                loop
                playsInline
                preload="auto"
