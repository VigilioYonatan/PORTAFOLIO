...
import { Cpu, X, MessageSquare, Activity } from "lucide-preact";
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-6 thin-scrollbar pb-20">
                    ...
                    {/* Special Modes */}
                     <div className="space-y-2">
                        <span className="text-[10px] text-muted-foreground uppercase tracking-widest pl-1">Reality Modes</span>
                     ...
                     {/* Audio Module */}
                    <div className="space-y-2">
                        <span className="text-[10px] text-muted-foreground uppercase tracking-widest pl-1">Audio Module</span>
                         <NeuroPlayer className="w-full" />
                    </div>

                    {/* System Stats */}
                    <div className="space-y-2">
                         <span className="text-[10px] text-muted-foreground uppercase tracking-widest pl-1">System Status</span>
                        <div className="p-2 border border-white/5 bg-zinc-950/20 rounded-lg space-y-2">
                             ...
                             <div className="grid grid-cols-3 gap-2 mt-2">
                                <div className="p-2 border border-white/5 bg-primary/5 rounded-sm flex flex-col items-center text-center gap-1">
                                    ...
                                    <span className="text-[8px] font-bold tracking-widest text-foreground">{t("layout.scalability")}</span>
                                </div>
                                <div className="p-2 border border-white/5 bg-zinc-900/40 rounded-sm flex flex-col items-center text-center gap-1">
                                    <div className="p-1 bg-indigo-500/20 rounded-full text-indigo-400">
                                       <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"></path></svg>
                                    </div>
                                    <span className="text-[8px] font-bold tracking-widest text-foreground">{t("layout.security")}</span>
                                </div>
                                <div className="p-2 border border-white/5 bg-zinc-900/40 rounded-sm flex flex-col items-center text-center gap-1">
                                    <div className="p-1 bg-emerald-500/20 rounded-full text-emerald-400">
                                       <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"></path></svg>
                                    </div>
                                    <span className="text-[8px] font-bold tracking-widest text-foreground">{t("layout.performance")}</span>
                                </div>
                             </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-4 pt-4 border-t border-white/5">
                        <div className="p-3 border border-white/5 bg-zinc-950/20 rounded-lg flex items-center justify-between">
                            <span className="text-[10px] text-muted-foreground uppercase tracking-widest">Lang</span>
                            <LanguageSwitcher />
                        </div>
                        <div className="p-3 border border-white/5 bg-zinc-950/20 rounded-lg flex items-center justify-between">
