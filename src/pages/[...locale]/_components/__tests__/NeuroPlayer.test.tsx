...
import NeuroPlayer from "../NeuroPlayer";
	...
	return {
		audioStore: {
			state: {
				...
				currentTrack: signal({ id: "1", title: "Test Track", artist: "Test Artist", cover: "" }),
				volume: signal(50),
				isMuted: signal(false),
				trackList: signal([{ id: "1", title: "Test Track", artist: "Test Artist", cover: "" }]),
