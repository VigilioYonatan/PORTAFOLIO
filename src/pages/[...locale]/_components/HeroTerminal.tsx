...
import { Globe, Smartphone, Server } from "lucide-preact";
...
export default function HeroTerminal() {
	...
	return (
		<section
			ref={containerRef}
			class="relative w-full py-12 flex flex-col items-center justify-center overflow-hidden min-h-[600px]"
		>
			...
			<div class="z-10 w-full max-w-4xl px-4">
				{/* Window Frame */}
				<div class="bg-black/60 border border-white/10 rounded-sm shadow-2xl backdrop-blur-md overflow-hidden relative group min-h-[450px]">
					...
					<div class="h-8 border-b border-white/10 flex items-center px-4 justify-between bg-zinc-950/40 relative z-20">
						<div class="flex items-center gap-2">
							...
							<span class="text-[10px] text-muted-foreground font-mono uppercase tracking-widest ml-4">root@system:~/init</span>
						</div>
					</div>

					{/* Content */}
					<div class="p-8 md:p-12 flex flex-col gap-6 relative z-10 font-mono">
						{/* Hero Content UI */}
						<div class="animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-500">
							...
							<div class="flex flex-col md:flex-row items-start md:items-end justify-between gap-8 md:gap-4 mb-8">
								...
								<div class="space-y-2 flex-1">
									<div class="p-1 px-3 bg-primary/10 border border-primary/20 inline-block rounded-sm">
										<span class="text-[9px] font-bold text-primary tracking-[0.3em] uppercase">MULTI_PLATFORM : ONLINE</span>
									</div>
									<h1 class="text-6xl md:text-8xl font-black tracking-tighter text-white leading-none">
										SOFTWARE<br />
										<span class="text-primary text-glow transition-all duration-75" style={{ textShadow: `0 0 ${20 + bassIntensity.value * 40}px rgba(6,182,212,0.6)` }}>
											ENGINEER_AI
										</span>
									</h1>
								</div>
							...
							<div class="space-y-2 font-mono text-xs md:text-sm text-muted-foreground mt-6">
								<p class="flex items-center gap-2">
									...
									Architecting intelligent <span class="text-foreground">AI & Automatization</span> solutions...
								</p>
								<p class="flex items-center gap-2">
									<span class="text-primary">&gt;</span>
									Crafting immersive <span class="text-foreground">Web & Mobile</span> experiences.
								</p>
								<p class="opacity-40 text-[10px] mt-4">## Stack: Python, PyTorch, React, NestJS, Docker, AWS.</p>
							</div>
							...
							<div class="flex flex-wrap gap-4 mt-8">
								<button
									type="button"
									class="px-8 py-3 bg-primary text-primary-foreground font-mono font-bold text-[11px] tracking-widest uppercase hover:bg-primary/90 transition-all shadow-[0_0_20px_rgba(6,182,212,0.3)] active:scale-95 flex items-center gap-3 group"
								>
								...
								<button
									type="button"
									class="px-8 py-3 bg-transparent border border-white/20 text-white font-mono font-bold text-[11px] tracking-widest uppercase hover:bg-white/5 transition-all active:scale-95 flex items-center gap-3"
								>
