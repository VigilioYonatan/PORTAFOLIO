...
export default function NeuroPlayer() {
	...
	if (isProtostarActive.value) {
		return (
			<div class="flex flex-col gap-3 p-1 rounded-2xl overflow-hidden relative mt-16 group border border-green-500/30 shadow-[0_0_20px_rgba(34,197,94,0.2)]">
						...
						<div class="flex items-center justify-center gap-3 flex-1">
							...
							>
								{isPlaying.value ? (
									...
									<PlayIcon size={16} fill="currentColor" class="ml-0.5" />
								)}
							</button>
							<button
								type="button"
