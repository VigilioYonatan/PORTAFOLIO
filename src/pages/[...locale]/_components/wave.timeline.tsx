						...
						: [
								{
									...
									description: "Designing autonomous agent infrastructure.",
								},
								{
									id: "mock-2",
									...
									company: "CYBER_CORP",
									description: "Building resilient distributed interfaces.",
								},
								{
									id: "mock-3",
									start_date: new Date("2020-01-01"),
									position: "INTERFACE_DESIGNER",
									company: "PRISM_LABS",
									description: "Creating next-gen visual languages.",
								},
							]
