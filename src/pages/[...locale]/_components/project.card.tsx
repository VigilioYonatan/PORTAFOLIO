			...
			<div class="grid grid-cols-1 md:grid-cols-2">
				<div class="aspect-video bg-zinc-900 relative overflow-hidden">
					{image ? (
						...
						<div class="w-full h-full flex items-center justify-center font-mono text-[10px] text-primary/20 bg-[radial-gradient(circle_at_center,var(--tw-gradient-stops))] from-primary/5 to-transparent">
				...
				<div class="p-8 flex flex-col justify-center relative">
					...
					<div class="mb-1 text-[10px] font-mono text-primary/60 tracking-[0.3em] uppercase">
						PROJECT_NODE
					</div>
					...
					<div class="flex flex-wrap gap-2 mb-8">
						{tags.map((tag) => (
							<span
								key={tag}
								class="px-2 py-0.5 border border-border bg-zinc-900/50 text-[9px] font-mono text-muted-foreground group-hover:border-primary/20 group-hover:text-primary transition-all"
							>
								{tag}
							</span>
						))}
