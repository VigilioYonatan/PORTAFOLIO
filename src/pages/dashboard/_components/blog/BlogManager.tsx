				...
				<div class="flex items-center gap-4">
                    ...
                    <div>
					    ...
					    <div class="flex items-center gap-3 mt-1">
                            <span class="text-[9px] text-primary font-bold font-mono uppercase tracking-[0.4em]">Content_Engine</span>
                            <span class="w-1 h-1 bg-white/20 rounded-full" />
                            <span class="text-[9px] text-muted-foreground font-mono uppercase tracking-[0.4em]">SEO_Optimized</span>
                        </div>
                    </div>
				</div>
