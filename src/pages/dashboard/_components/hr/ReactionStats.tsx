...
export default function ReactionStats() {
	...
	return (
		<div class="space-y-4">
			<h3 class="text-xs font-black font-mono tracking-[0.3em] uppercase mb-4">
				ENTITY_REACTIONS
			</h3>
					...
					: Object.entries(icons).map(([type, icon]) => (
							...
							>
								<div class="flex items-center gap-3">
									...
									<span class="text-[9px] font-black font-mono tracking-widest text-muted-foreground/60 uppercase">
										{type}
									</span>
								</div>
