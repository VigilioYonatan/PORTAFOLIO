...
interface MessageDetailProps {
	...
	onClose: () => void;
	onUpdate: (val?: ContactMessageSchema) => void;
		...
		<div class="flex flex-col h-full bg-zinc-900/50">
			...
			<div class="flex-1 p-8 overflow-auto custom-scrollbar">
				<div class="bg-zinc-900/40 border border-white/5 p-8 rounded-3xl backdrop-blur-md relative overflow-hidden shadow-inner">
					...
					<div class="relative z-10 space-y-4">
						<div class="text-[10px] font-black tracking-[0.5em] text-primary/40 uppercase mb-6 flex items-center gap-2">
			...
			<div class="p-8 border-t border-white/5 flex gap-4 bg-black/20">
				...
				<button
					...
					class="ml-auto px-6 py-2.5 bg-red-500/10 text-red-500 text-[10px] font-black tracking-widest uppercase rounded-lg hover:bg-red-500/20 transition-all border border-red-500/20"
				>
					DISCARD_SIGNAL
				</button>
			</div>
