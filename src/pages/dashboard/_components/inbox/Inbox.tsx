		...
		<div class="h-[calc(100vh-8rem)] flex flex-col animate-in fade-in duration-500 relative">
			...
			<div class="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-white/5 pb-8 relative z-10">
				<div class="flex items-center gap-5">
                    ...
                    <div>
					    <h2 class="text-3xl font-black font-mono text-white tracking-tighter uppercase italic selection:bg-primary selection:text-black">
						    {">"} SECURE_INBOX_COMM
					    </h2>
					    <div class="flex items-center gap-3 mt-1">
                            <span class="text-[9px] text-primary font-bold font-mono uppercase tracking-[0.4em]">E2EE_PROTOCOL</span>
                            <span class="w-1 h-1 bg-white/20 rounded-full" />
                            <span class="text-[9px] text-muted-foreground font-mono uppercase tracking-[0.4em]">Ready_To_Receive</span>
                        </div>
                    </div>
				</div>
                ...
                <div class="flex items-center gap-6 bg-zinc-950/60 p-4 rounded-sm border border-white/5 backdrop-blur-md">
                    <div class="flex flex-col items-end">
                        <div class="flex items-center gap-2 text-[8px] font-mono text-primary font-black tracking-widest uppercase mb-1">
                            <WifiIcon size={10} />
                            <span>NODE_CONNECTED</span>
                        </div>
                        <span class="text-[10px] font-mono text-white font-bold tracking-widest uppercase opacity-60">ADMIN_GATEWAY_v1</span>
                    </div>
