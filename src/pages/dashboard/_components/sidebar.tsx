		...
		() => [
			{
				...
				items: [
					{
						label: t("dashboard.sidebar.panel"),
						href: "/dashboard",
						icon: LayoutDashboard,
					},
					{
						label: t("dashboard.sidebar.documents"),
						href: "/dashboard/documents",
						icon: FileText,
					},
					{
						label: t("dashboard.sidebar.ai"),
						href: "/dashboard/ai",
						icon: Bot,
					},
				],
			},
			{
				...
				items: [
					...
					{
						label: t("dashboard.sidebar.music"),
						href: "/dashboard/shared",
						icon: Music,
					},
					{
						label: t("dashboard.sidebar.technologies"),
						href: "/dashboard/tech",
						icon: Cpu,
					},
					{
