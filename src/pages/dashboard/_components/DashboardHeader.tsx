import { Activity, Bell, Cpu, Search, WifiIcon, ShieldCheckIcon } from "lucide-preact";
		...
		<header class="h-16 border-b border-white/5 bg-zinc-950/60 backdrop-blur-md sticky top-0 z-30 flex items-center justify-between px-8">
			...
			<div class="flex items-center gap-6 relative z-10">
				<div class="flex items-center gap-3 text-[10px] font-mono uppercase tracking-[0.3em] text-muted-foreground">
					...
					<span class="text-white font-black group hover:text-primary transition-colors cursor-pointer">SYS_ROOT</span>
			...
			<div class="flex items-center gap-8 relative z-10">
				...
				<div class="hidden lg:flex items-center gap-6 px-5 py-2 bg-black/40 border border-white/5 rounded-sm relative overflow-hidden group hover:border-primary/20 transition-all">
                    ...
                    <div class="flex flex-col gap-1">
                        <div class="flex items-center gap-2 text-[8px] font-mono text-primary text-glow font-black tracking-widest uppercase">
						    <Activity size={10} class="animate-pulse" />
						    <span>STATUS: ONLINE</span>
					    </div>
                        <div class="flex items-center gap-2 text-[8px] font-mono text-muted-foreground font-bold tracking-widest uppercase opacity-60">
                            <WifiIcon size={10} />
                    ...
                    <div class="flex flex-col gap-1">
                        <div class="flex items-center gap-2 text-[8px] font-mono text-white tracking-widest uppercase font-bold">
						    <Cpu size={10} />
						    <span>LOAD: 12.4%</span>
					    </div>
                        <div class="flex items-center gap-2 text-[8px] font-mono text-muted-foreground font-bold tracking-widest uppercase opacity-60">
				...
				<div class="flex items-center gap-3">
					<button class="w-9 h-9 flex items-center justify-center rounded-sm bg-white/5 border border-white/5 text-muted-foreground hover:bg-primary/10 hover:text-primary hover:border-primary/20 transition-all group">
						<Search size={16} class="group-hover:scale-110 transition-transform" />
					</button>

					<div class="relative">
						<button class="w-9 h-9 flex items-center justify-center rounded-sm bg-white/5 border border-white/5 text-muted-foreground hover:bg-primary/10 hover:text-primary hover:border-primary/20 transition-all group">
							<Bell size={16} class="group-hover:scale-110 transition-transform" />
						</button>
				...
				<div class="flex items-center gap-4 group cursor-pointer">
					<div class="flex flex-col items-end hidden sm:flex">
						...
						<span class="text-[8px] text-primary/60 font-bold tracking-widest uppercase">SYS.ONLINE</span>
					</div>
					<div class="w-10 h-10 rounded-sm border border-primary/30 bg-primary/10 flex items-center justify-center overflow-hidden relative group-hover:border-primary transition-colors">
						...
						<div class="w-full h-full bg-gradient-to-tr from-primary/40 to-transparent group-hover:scale-110 transition-transform duration-500" />
                        {/* Mock Avatar */}
