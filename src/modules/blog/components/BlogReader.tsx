...
import { Clock, BookOpen, Share2 } from "lucide-preact";
import FuturisticMDX from "./FuturisticMDX";
    ...
    return (
        <div class={cn("relative", className)} ref={contentRef}>
            ...
            <div class="fixed top-0 left-0 w-full h-[2px] bg-zinc-900 z-[100]">
                ...
                />
                <div class="absolute top-2 right-4 font-mono text-[9px] text-primary/60 font-bold tracking-widest bg-black/80 px-2 py-0.5 rounded-sm border border-primary/20 backdrop-blur-md">
            ...
            <header class="mb-12 border-b border-white/5 pb-12">
                <div class="flex items-center gap-2 mb-4">
                    ...
                    <span class="text-[10px] font-mono font-black text-primary/60 tracking-[0.3em] uppercase">NEURAL_STDOUT // ARTICLE</span>
                </div>
                ...
                <div class="flex flex-wrap items-center gap-6 text-[10px] font-mono font-bold text-muted-foreground/60 uppercase tracking-[0.2em]">
            ...
            <main class="relative">
                ...
                <aside class="absolute -left-32 top-0 hidden lg:flex flex-col gap-8 opacity-40 hover:opacity-100 transition-opacity">
                    <div class="flex flex-col gap-1 border-l border-primary/20 pl-4 py-2">
                        ...
                        <span class="text-[10px] font-mono font-bold text-primary">v2.4.0</span>
                    </div>
                    <div class="flex flex-col gap-1 border-l border-primary/20 pl-4 py-2">
                        <span class="text-[8px] font-mono text-zinc-500">STATUS</span>
                        <span class="text-[10px] font-mono font-bold text-green-500">VERIFIED</span>
                    </div>
                </aside>
