	...
	return (
		<div class="flex items-center gap-6 py-8 border-t border-b border-border/50 my-12 bg-card/10 px-6 rounded-sm backdrop-blur-md relative overflow-hidden group">
			...
			<div class="flex gap-6 relative z-10">
					...
					<div class="relative">
						<HeartIcon
							...
							class={cn(
								...
								isLiked.value ? "fill-current scale-110" : "group-hover/btn:scale-110",
							)}
						/>
						{isLiked.value && (
				...
				<button class="flex items-center gap-2.5 text-muted-foreground hover:text-primary transition-all group/btn">
					<MessageSquareIcon size={18} class="group-hover/btn:scale-110 transition-transform" />
					<span class="font-mono text-xs font-bold tracking-widest">
			...
			<div class="ml-auto relative z-10">
				<button class="flex items-center gap-2 text-primary/60 hover:text-primary transition-all font-mono text-[10px] font-bold tracking-[0.3em] uppercase group/share">
					<Share2Icon size={16} class="group-hover/share:rotate-12 transition-transform" />
