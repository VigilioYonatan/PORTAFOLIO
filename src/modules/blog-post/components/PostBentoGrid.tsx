...
import BlogPostStore from "@modules/blog-post/components/BlogPostStore";
import BlogPostUpdate from "@modules/blog-post/components/BlogPostUpdate";
import { blogPostDestroyApi } from "@modules/blog-post/apis/blog-post.destroy.api";
import type { BlogPostIndexMethods } from "@modules/blog-post/apis/blog-post.index.api";
...
import { Edit, ExternalLink, Eye, FileText, Plus, Search, Trash } from "lucide-preact";
	...
	return (
		<div class="space-y-6">
			...
			{query.isLoading ? (
				<div class="w-full h-64 flex items-center justify-center">
					<div class="flex flex-col items-center gap-4">
						...
						<span class="text-[10px] font-bold font-mono tracking-widest text-muted-foreground animate-pulse">
								...
								<div className="mt-auto pt-4 border-t border-white/5 flex items-center justify-between">
									<div className="flex gap-1">
										<button
											...
											title="Edit Article"
											onClick={() => (editingPost.value = post)}
										>
											<Edit size={14} />
										</button>
										<button
                    ...
                    <div className="flex items-center gap-1">
                          {paginator.pagination.paginator.pages.map((page: number) => (
                             <button
                                ...
                                class={cn(
                                    "w-8 h-8 flex items-center justify-center text-[10px] font-black font-mono rounded-lg transition-colors border",
			...
			<Modal
				...
				onClose={() => (editingPost.value = null)}
				contentClassName="max-w-4xl w-full self-start bg-zinc-950 border border-white/10"
			>
				<BlogPostUpdate
