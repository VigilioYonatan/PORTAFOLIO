...
export default function FloatingReactionBar({
	onCommentClick,
	...
	return (
		<div class="fixed left-4 lg:left-8 top-1/2 -translate-y-1/2 z-30 hidden xl:flex flex-col gap-4">
			<div class="flex flex-col gap-2 p-2 bg-card/50 backdrop-blur-xl border border-border rounded-full shadow-2xl">
				<button
					type="button"
					onClick={() => {
				...
				<button
					...
					class="w-10 h-10 rounded-full flex items-center justify-center hover:bg-secondary text-muted-foreground hover:text-primary transition-all"
				>
				...
				>
					<BookmarkIcon
						size={20}
						fill={isBookmarked.value ? "currentColor" : "none"}
					/>
				</button>
