	...
	return (
		<div class="space-y-6 py-2">
			<div class="flex flex-col gap-1 border-b border-white/5 pb-4 mb-4">
				<span class="text-[9px] font-black font-mono tracking-[0.5em] text-primary uppercase">
			...
			<div class="grid grid-cols-1 md:grid-cols-2 gap-4">
				<div class="bg-zinc-900/40 p-4 rounded-xl border border-white/5 space-y-4">
					<div class="flex flex-col gap-1">
						<span class="text-[9px] font-black font-mono text-muted-foreground/40 uppercase tracking-widest flex items-center gap-2">
			...
			<div class="bg-primary/5 p-6 rounded-2xl border border-primary/10 relative overflow-hidden">
				...
				<div class="relative z-10">
					<span class="text-[9px] font-black font-mono text-primary uppercase tracking-widest block mb-4">
