...
describe("LoginForm", () => {
	...
	it("renders login form correctly", () => {
		...
		expect(screen.getByText("auth.terminal.uid")).toBeInTheDocument();
		expect(screen.getByText("auth.terminal.passphrase")).toBeInTheDocument();
		expect(
			screen.getByRole("button", { name: /auth\.terminal\.execute/i }),
		).toBeInTheDocument();
