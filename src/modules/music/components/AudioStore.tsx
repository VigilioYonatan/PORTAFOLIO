...
import { Music, Calendar, Info, Headphones, Image as ImageIcon } from "lucide-preact";
...
export default function AudioStore({ refetch, onClose }: AudioStoreProps) {
	...
	const musicStoreForm = useForm<MusicStoreDto>({
		resolver: zodResolver(musicStoreDto),
		mode: "all",
	});

	console.log(musicStoreForm.formState.errors);
