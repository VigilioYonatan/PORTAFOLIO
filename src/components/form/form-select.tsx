		...
		<div class="space-y-2 w-full" ref={selectRef} {...rest}>
			...
			<div class="relative">
				...
				{isOpen.value && !disabled && (
					<div class="absolute z-10 w-full mt-1 border border-input rounded-[var(--radius-lg)] shadow-lg max-h-60 overflow-auto bg-popover">
						{/* Options list */}
						{array.length > 0 ? (
							<ul>
								{array.map((option) => (
