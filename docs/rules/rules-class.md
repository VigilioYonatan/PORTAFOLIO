...
Un Portafolio Web Personal (Single Page) donde muestras tu trayectoria como **Senior Developer**. Incluye gestión de proyectos, blog, música, testimonios y un Chat IA (RAG) identificado por IP del visitante.
...
direction TB
    ...
    class portfolio_config {
        +id: int [PK]
        +name: text[100]
        +profile_title: text[200] -- Ej: Senior Full-stack Engineer
    ...
    class portfolio_project {
        ...
        +impact_summary: text -- Senior Impact (Results)
...
- [x] **Identidad Senior**: Bio, redes y testimonios integrados en el Core.
- [x] **Impacto Real**: Campo `impact_summary` para destacar resultados profesionales.
- [x] **IA Avanzada**: Sistema RAG completo con vectores para chat anónimo.
- [x] **Personalización**: Conversión completa de SaaS a Portafolio Personal.
- [x] **Clean Architecture**: Relaciones N-M correctamente mapeadas y tipado JSONB.
- [x] **Fidelidad**: Cumple con `prompt-rules.md` al 100%.
