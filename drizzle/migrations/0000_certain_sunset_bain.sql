...
CREATE TYPE "public"."notification_type_enum" AS ENUM('NEW_MESSAGE', 'NEW_COMMENT', 'SYSTEM_ALERT');--> statement-breakpoint
...
CREATE TYPE "public"."reaction_type_enum" AS ENUM('LIKE', 'LOVE', 'ROCKET', 'FIRE');--> statement-breakpoint
...
CREATE TYPE "public"."timezone_enum" AS ENUM('UTC', 'America/Lima', 'America/New_York');--> statement-breakpoint
...
CREATE TABLE "techeables" (
	...
	"techeable_type" varchar(50) NOT NULL,
	"technology_id" integer NOT NULL,
	"tenant_id" integer NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "techeables_tenant_unique" UNIQUE("tenant_id","techeable_type","techeable_id","technology_id")
);
--> statement-breakpoint
...
CREATE INDEX "techeables_tenant_idx" ON "techeables" USING btree ("tenant_id");--> statement-breakpoint
CREATE INDEX "techeables_techeable_idx" ON "techeables" USING btree ("techeable_type","techeable_id");--> statement-breakpoint
CREATE INDEX "techeables_technology_idx" ON "techeables" USING btree ("technology_id");--> statement-breakpoint
